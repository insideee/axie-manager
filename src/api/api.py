...
class FullData:
    ...
    def __init__(self, ronin_address: str) -> None:
        ...
        self.response = requests.request('GET', self.url+f'/{self.ronin_acc}', headers=self.headers, params=self.querystring)
...
class AccAxie:
    ...
    def __init__(self, ronin_address: str) -> None:
        ...
        self.response = self.responce_treatment()      

        self.data = ast.literal_eval(self.response)
        
    def responce_treatment(self) -> str:
